...
16. Create the Deployment, Pod and Service for the Database: `kubectl create -f .\basic-miner-db.yaml`
17. Create the Deployment, Pod and Service for the Web server: `kubectl create -f .\basic-miner-web.yaml`
...
Note: All data in the database will be lost if the Cluster is deleted - since deleting the cluster removes all Azure resources in the resource group - including the Azure Disk where the data is kept.
